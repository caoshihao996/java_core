...
public class StringTest {
    ...
    String字符串，使用一对“”引起来表示
       ...
       5.通过字面量给一个字符串赋值，此时的字符串声明在字符串常量池中。
     */
    @Test
    public void test1(){
        String s1 = "abc";//字面量
    ...
    @Test
    public void test2(){
        //此时s1和s2的数据javaEE声明在方法区中的字符串常量中。
        String s1 = "javaEE";
        String s2 = "javaEE";
        ...
        Person p1 = new Person("Tom",12);//Tom字面量定义
    ...
    public void test3(){
        ...
        String s5 = s1 + "hadoop";//有变量参与的相当于new，地址值指向堆空间
        String s6 = "javaEE" + s2;
        String s7 = s1 + s2;
        ...
        String s8 = s5.intern();//返回值得到的s8使用常量池中已经存在的JavaEEhadoop
